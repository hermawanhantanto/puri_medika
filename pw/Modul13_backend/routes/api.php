...
Route::middleware('auth:api')->group(function(){
    ...
    Route::post('contents/{id}/thumbnail',[App\Http\Controllers\Api\ContentController::class,'updateThumbnail']);

    Route::get('/favourites/user/{id}',[App\Http\Controllers\Api\FavouriteController::class,'index']);
    Route::post('/favourites',[App\Http\Controllers\Api\FavouriteController::class,'store']);
    Route::delete('/favourites/user/{id}',[App\Http\Controllers\Api\FavouriteController::class,'destroy']);
});
